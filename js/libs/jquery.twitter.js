  ...
  */
  ...
  $.fn.getTwitter = function (options) {
    ...
    return this.each(function () {
      ...
      if (o.showHeading) {
        c.append("<h2 class=\"widget-title\">" + o.headingText + "</h2>");
      }

      // add twitter list to container element
      var twitterListHTML = "<ul id=\"twitter_update_list\" class=\"without-style\"></ul>";
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $.each(data, function (key, val) {
            ...
            var cssClass = isEven(key) ? "" : " tweet_odd";

            var tweetHTML = "<li class=\"tweet_first" + cssClass + "\"><span class=\"tweet_text\">" + replaceURLWithHTMLLinks(val.text) + "</span>";
